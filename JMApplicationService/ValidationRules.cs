...
namespace JMApplicationService
{
    ...
    public class ValidationRules
    {
        ...
        ///// </summary>
        ///// <param name="propertyName"></param>
        //public Boolean ValidatePhoneNumber(string propertyName)
        //{
        //    return ValidatePhoneNumber(propertyName, propertyName);
        //}
        ///// <summary>
        ///// Validate Phone Number
        ///// </summary>
        ///// <param name="propertyName"></param>
        //public Boolean ValidatePhoneNumber(string propertyName, string friendlyName)
        //{
        //    object valueOf = GetPropertyValue(propertyName);
        //    string stringValue;
        ...
        //    if (Validations.ValidatePhoneNumber(valueOf.ToString()) == false)
        //    {
        //        string emailAddressErrorMessage = friendlyName + " is not a valid phone number";
        //        AddValidationError(propertyName, emailAddressErrorMessage);
        //        return false;
        //    }
