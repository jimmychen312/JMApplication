var JMWebApplication = function () {
    ...
    return {
        ...
        FormatDateTime: function (jsonDate) {
            ...
            var month = JMWebApplication.Pad(d.getMonth() + 1);
            var day = JMWebApplication.Pad(d.getDate());
            var hour = JMWebApplication.Pad(d.getHours());
            var minutes = JMWebApplication.Pad(d.getMinutes());
